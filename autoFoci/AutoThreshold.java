...
/**
The methods are taken from the fiji Auto_Threshold class:
http://fiji.sc/Auto_Threshold
https://github.com/fiji/Auto_Threshold

but they are modified to allow double[] histograms as input. 
...
public class AutoThreshold {
    ...
    public static int Huang(double[] data) {
    ...
    public static int Intermodes(double[] data) {
        ...
        while (!bimodalTest(iHisto)) {
            ...
            if (iter > 10000) {
                threshold = -1;
                // IL.log("Intermodes Threshold not found after 10000 iterations.");
                return threshold;
            }
        }
    ...
    public static int IsoData(double[] data) {
        ...
        while (true) {
            ...
            g++;
            if (g > data.length - 2) {
                // IL.log("IsoData Threshold not found.");
                return -1;
            }
        }
        return g;
    ...
    public static int IJDefault(double[] data) {
    ...
    public static int Li(double[] data) {
    ...
    public static int MaxEntropy(double[] data) {
    ...
    public static int MinErrorI(int[] data) {
        ...
        while (threshold != Tprev) {
            ...
            sqterm = (w1 * w1) - w0 * w2;
            if (sqterm < 0) {
                // IL.log("MinError(I): not converging. Try \'Ignore black/white\' options");
                return threshold;
            }
            ...
            if (Double.isNaN(temp)) {
                // IL.log ("MinError(I): NaN, not converging. Try \'Ignore black/white\' options");
                threshold = Tprev;
            } else
                threshold = (int) Math.floor(temp);
            //// IL.log("Iter: "+ counter+++"  t:"+threshold);
        }
        return threshold;
    }
    ...
    public static int Minimum(int[] data) {
        ...
        while (!bimodalTest(iHisto)) {
            ...
            if (iter > 10000) {
                threshold = -1;
                // IL.log("Minimum Threshold not found after 10000 iterations.");
                return threshold;
            }
        }
    ...
    public static int Moments(double[] data) {
    ...
    public static int Otsu(double[] data) {
        ...
        double S; // The total intensity of the image
        int L = data.length;
    ...
    public static int RenyiEntropy(double[] data) {
        // Kapur J.N., Sahoo P.K., and Wong A.K.C. (1985) "A New Method for
        // Gray-Level Picture Thresholding Using the Entropy of the Histogram"
        // Graphical Models and Image Processing, 29(3): 273-285
        // M. Emre Celebi
    ...
    public static int Shanbhag(double[] data) {
    ...
    public static int Triangle(double[] data) {
    ...
    public static int Yen(double[] data) {
